...
We conducted an extensive set of weak scalability tests on the JURECA supercomputer at the JŸlich Supercomputing Centre (JSC), 
...
To the best of our knowledge, the selected smoothers and local solvers have not been
